                        ...
                        <div class="card-body">
                            <form action="UpdateBook">
                                <div class="form-group">
                                    ...
                                    <input name="isbn" id="ISBN" type="text" class="form-control" value="${bookMatched.ISBN}" disabled="">
                                    <input name="isbn" id="ISBN" type="hidden" class="form-control" value="${bookMatched.ISBN}" >
                                </div>
                                <div class="form-group">
                                    <label for="btitle">Book Title</label>
                                    <input name="title" id="btitle" type="text" class="form-control" value="${bookMatched.title}" required="">
                                </div>
                                <div class="form-group">
                                    <label for="des">Description</label>
                                    <textarea id="des" name="description" rows="8" cols="12" class="form-control">${bookMatched.description}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="author">Author</label>
                                    <input name="author" id="author" type="text" class="form-control" value="${bookMatched.author}" required="">
                                </div>
                                <div class="form-group">
                                    <label for="publisher">Publisher</label>
                                    <input name="publisher" id="publisher" type="text" class="form-control" value="${bookMatched.publisher}" required="">
                                </div>
                                <div class="form-group">
                                    <label for="price">Price($)</label>
                                    <input name="price" id="price" type="number" class="form-control" value="${bookMatched.price}" step="0.01" min="0">
                                </div>
                                <div class="form-group">
                                    <label for="quantity">Quantity</label>
                                    <input name="quantity" id="quantity" type="number" class="form-control" value="${bookMatched.quantityLeft}" max="1000" min="0">
                                </div>
                                <div class="form-group">
                                    <label for="image">Image Link</label>
                                    <input name="image" id="image" type="text" value="${bookMatched.image_link}" class="form-control">
                                </div>
                                <div class="form-group" id="tag-group">
                                    ...
                                    <c:forEach var="bookTag" items="${requestScope.bookTags}">
                                        <%no++;%> 
                                        <span>${bookTag}</span>
                                        <input type="checkbox" id="tag<%=no%>" name="tags" value="${bookTag}" checked>&nbsp;&nbsp;&nbsp;&nbsp;
                                    </c:forEach>
                                </div>
                                <div class="form-group">
                                    <input type="submit" class="form-control" value="Update Book">
                                </div>
                            </form>
                        </div>
                    </div>
