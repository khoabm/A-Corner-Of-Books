 ...
 * @author ASUS
 */
@WebServlet(name = "DeleteFavoriteController", urlPatterns = {"/deletefavorite"})
public class DeleteFavoriteController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean check = manager.deleteFavorite(email, isbn);
        
        if(check == true)
            response.sendRedirect("favourite?index="+index);
    }
