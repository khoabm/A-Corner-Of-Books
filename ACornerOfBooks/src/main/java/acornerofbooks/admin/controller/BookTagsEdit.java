 ...
 * @author ASUS
 */
@WebServlet(name = "EditBookController", urlPatterns = {"/edit"})
public class BookTagsEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BookDTO book = manager.searchSingleBook(isbn);     
        List<String> tags = manager.findTagsExcept(isbn);
        List<String> bookTags = manager.findTags(isbn);
