 ...
 * @author ASUS
 */
@WebServlet(name = "BookManagement", urlPatterns = {"/BookManagement"})
public class BookManagement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(index==null) indexP = 1;
        else indexP = Integer.parseInt(index);
        
        
        BookManager manager = new BookManager();
        List<BookDTO> list = manager.getListAdmin(indexP);
        int count = manager.totalBooks();
